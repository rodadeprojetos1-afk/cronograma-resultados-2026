const CACHE = 'roda-de-projetos-v11';
const ASSETS = ['./', './index.html', './styles.css?v=10', './app.js?v=10', './dashboard-ui.js?v=10', './participants.js', './links.js', './approved.js', './manifest.webmanifest', './icon.svg'];
